...
OUTPUT_DIR="${OUTPUT_DIR:-results_freq/decode_freq_sweep_full}"
...
STRATEGY_NAMES="${STRATEGY_NAMES:-baseline_decode_profile,decode_freq_sweep}"

python run_decode_freq_sweep.py \
...
python analyze_decode_freq_sweep.py \
