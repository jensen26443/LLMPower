...
STRATEGY_NAMES="baseline_350w,ff_v2_recommended,ff_v2_decode_pid_stable,ff_v2_decode_pid_adaptive"

echo "=========================================="
echo "前馈 + Decode PID 控制对比评估"
echo "=========================================="
echo ""
echo "配置参数:"
...
CMD=(
    python run_feedforward_decode_pid_evaluation.py
...
echo "步骤1: 运行前馈 + Decode PID 实验..."
"${CMD[@]}"

echo ""
echo "步骤2: 分析实验结果..."
python analyze_feedforward_decode_pid_evaluation.py \
