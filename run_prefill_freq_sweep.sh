...
OUTPUT_DIR="${OUTPUT_DIR:-results_freq/prefill_freq_sweep_full}"
...
STRATEGY_NAMES="${STRATEGY_NAMES:-baseline_prefill_profile,prefill_freq_sweep}"

python run_prefill_freq_sweep.py \
...
python analyze_prefill_freq_sweep.py \
